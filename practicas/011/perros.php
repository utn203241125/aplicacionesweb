...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootswatch@5.1.0/dist/slate/bootstrap.min.css" rel="stylesheet"
                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <div id="divLista" class="list-group">
                            <a href="javascript: alert('SIN_PERROS');"
                                class="list-group-item list-group-item-action">Cargando. . .</a>
                        </div>
                    </div>
                    <div class="col-8">
                        <img id="imgPerro" src="https://www.antonio.com.mx/imagenes/perro.png" class="img-fluid"
                            alt="Perros">
                    </div>
                </div>
            </div>
